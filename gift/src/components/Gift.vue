<template>
  <div class="gift" @click="handleClickGift">
    <div :class="`gift__bow ${hiddenClass}`">
      <div class="gift__bow-left"></div>
      <div class="gift__bow-right"></div>
      <div class="gift__bow-center"></div>
    </div> 
    <div  :class="`gift__box ${hiddenClass}`">
      <div class="gift__lid-shadow"></div>
    </div>
    <div  :class="`gift__lid ${hiddenClass}`"></div>
